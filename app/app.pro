...
LIBS += -L..\..\app\SFML\lib -lsfml-audio -lsfml-graphics -lsfml-main -lsfml-network -lsfml-system -lsfml-window
...
INCLUDEPATH += ..\..\app\SFML\include
DEPENDPATH += ..\..\app\SFML\include
